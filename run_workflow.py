...
def run_full_workflow():
    ...
    # Step 4: 数据分析
    print("\n" + "━" * 60)
    print(f"  🔶 STEP 4 / {total_steps} : 数据分析")
    print("━" * 60)
    try:
    ...
    # Step 5: ML预测
    print("\n" + "━" * 60)
    print(f"  🔶 STEP 5 / {total_steps} : 机器学习预测")
    print("━" * 60)
    try:
    ...
    # Step 6: 报告生成
    print("\n" + "━" * 60)
    print(f"  🔶 STEP 6 / {total_steps} : 报告生成")
    print("━" * 60)
    try:
    ...
    if len(sys.argv) > 1:
        try:
            ...
            if sys.argv[1] == "--help":
                ...
                print("  python run_workflow.py 4      # 只运行数据分析")
                print("  python run_workflow.py 5      # 只运行ML预测")
                print("  python run_workflow.py 6      # 只运行报告生成")
            else:
