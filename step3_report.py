        ...
        for code, name in stocks.items():
            ...
            <div class="stock-card">
                <div class="stock-header">
                    ...
                    <div class="stock-price"><span class="price">{price}</span><span style="color:{change_color};font-size:13px;">近5日 {change_5d}%</span></div>
                </div>
        ...
        <div class="us-stock-card">
            <div class="us-stock-header">
                ...
                <div class="us-price-area">
                    <span class="us-price">${price:.2f}</span>
...
<h2>🎯 今日概览</h2>
<div class="summary-cards">
    <div class="card"><div class="label">上涨</div><div class="number up">{stats.get('上涨数','-')}</div></div>
    <div class="card"><div class="label">下跌</div><div class="number down">{stats.get('下跌数','-')}</div></div>
    <div class="card"><div class="label">平均涨跌幅</div><div class="number {'up' if stats.get('平均涨跌幅',0)>=0 else 'down'}">{stats.get('平均涨跌幅','-')}%</div></div>
    <div class="card"><div class="label">总成交额</div><div class="number" style="color:#60a5fa">{stats.get('总成交额(亿)','-')}亿</div></div>
</div>
<div class="section">
